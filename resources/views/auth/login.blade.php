    ...
    <div class="forms-container">
      <div class="signin-signup">
        <form class="sign-in-form" id="sign_in_form">
          ...
          <span class="error-text email_error" style="color:#ff0000"></span>
          <span class="error-text password_error" style="color:#ff0000"></span>
        ...
        <form class="sign-up-form" id="sign_up_form">
          ...
          <span class="error-text signup_name_error" style="color:#ff0000"></span>
          <span class="error-text signup_email_error" style="color:#ff0000"></span>
          <span class="error-text signup_phone_error" style="color:#ff0000"></span>
          <span class="error-text signup_password_error" style="color:#ff0000"></span>
          <div class="input-field">
