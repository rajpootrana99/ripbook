        ...
        jQuery(document).ready(function () {
            am4core.ready(function () {
                ...
                (o.tooltipText = "{name}"),
                    ...
                    (o.states.create("hover").properties.fill =
                        a.colors.getIndex(9));
                ...
                (i.tooltipText = "{name}"),
                    ...
                    (i.states.create("hover").properties.fill =
                        a.colors.getIndex(9)),
    ...
    jQuery("#am-columnlinr-chart").length &&
        am4core.ready(function () {
            ...
            (a.name = "Income"),
                ...
                (a.columns.template.propertyFields.strokeDasharray =
                    "columnDash"),
    ...
    jQuery("#am-barline-chart").length &&
        am4core.ready(function () {
            ...
            (t.dataFields.category = "year"),
                ...
                (t.renderer.grid.template.location = 0),
                (e.xAxes.push(new am4charts.ValueAxis()).renderer.opposite =
                    !0);
            var a = e.series.push(new am4charts.ColumnSeries());
            ...
            series: [
                {
                    ...
                    yAxis: 1,
                    data: [
                        49.9, 71.5, 106.4, 129.2, 144, 176, 135.6, 148.5, 216.4,
                        194.1, 95.6, 54.4,
                    ],
                    color: "#fbc647",
                    tooltip: {
                ...
                },
                {
                    ...
                    type: "spline",
                    data: [
                        7, 6.9, 9.5, 14.5, 18.2, 21.5, 25.2, 26.5, 23.3, 18.3,
                        13.9, 9.6,
                    ],
                    color: "#827af3",
                    tooltip: {
        ...
        series: [
            {
                name: "Male",
                data: [
                    -2.2, -2.1, -2.2, -2.4, -2.7, -3, -3.3, -3.2, -2.9, -3.5,
                    -4.4, -4.1, -0,
                ],
                color: "#827af3",
            },
    ...
    jQuery("#home-chart-06").length &&
        am4core.ready(function () {
            ...
            (s.dataFields.categoryX = "category"),
                ...
                (s.tooltipText =
                    "open: {openValueY.value} close: {valueY.value}"),
